...
const Hero = () => {
  ...
  return (
    <>
      <section className="h-[85vh] bg-cover relative bg-center bg-neutral-100 bg-hero-pattern bg-blend-multiply bg-no-repeat filter brightness-75 contrast-125">
        <div className="container">
          <div className="flex flex-col justify-center items-center text-[#fff] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <h2
              className=" text-center text-white text-[34px] max-lg:text-[24px]"
              style={{
            ...
            <h1 className="text-white text-[72px] max-lg:text-[52px] font-bold pb-3">
              {t("mainTitleCountry")}
            </h1>
            <button
              className="relative inline-flex items-center font-bold justify-center px-12 py-3 max-lg:py-2 max-lg:px-8 text-[20px] transition-all bg-blue-500 rounded-2xl group overflow-hidden"
